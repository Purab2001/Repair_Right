    ...
    >
      ...
      <div className="relative z-10 px-4 md:px-14 lg:px-28 container mx-auto py-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div className="inline-block" variants={fadeInUpVariants}>
            ...
            <motion.p
              ...
              variants={fadeInUpVariants}
            >
              Connect with skilled professionals, share your expertise, or find
              the perfect repair service for your needs. Our platform makes
              booking reliable services simple and secure.
            </motion.p>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="text-white">
                  ...
                  <p className="text-gray-300">
                    Certified experts for all your repair needs
                  </p>
                </div>
              </div>
            </motion.div>
