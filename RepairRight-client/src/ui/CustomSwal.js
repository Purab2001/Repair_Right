...
export function confirmLogout() {
    return Swal.fire({
        ...
        customClass: {
            ...
            confirmButton: 'swal2-confirm bg-indigo-600 hover:bg-indigo-700 text-white rounded px-6 py-2 cursor-pointer',
            cancelButton: 'swal2-cancel bg-base-200 text-base-content rounded px-6 py-2 cursor-pointer',
...
export function swalRegisterSuccess(userName = '') {
    return Swal.fire({
        ...
        text: userName ? `Welcome, ${userName}!` : 'Your account has been created.',
        icon: 'success',
