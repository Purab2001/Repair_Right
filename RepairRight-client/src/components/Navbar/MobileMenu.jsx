...
import { FiHome, FiTool, FiPlus, FiSettings, FiCalendar, FiCheckSquare } from 'react-icons/fi'
...
const MobileMenu = ({ isMenuOpen, toggleMenu, user }) => {
    const mobileMenuItems = [
        ...
        ...(user ? [
            ...
            { to: '/booked-services', label: 'Booked Services', icon: FiCalendar },
                ...
                >
                    <div className="p-2">
                        ...
                        <motion.div
                            initial={{ opacity: 0, x: -20 }}
                            animate={{ opacity: 1, x: 0 }}
                            transition={{ delay: mobileMenuItems.length * 0.1, duration: 0.3 }}
