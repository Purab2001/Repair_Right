          ...
          <div className="space-y-6 flex flex-col flex-grow">
            ...
            {isServiceProvider ? (
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={onBookNow}
                className="inline-flex items-center justify-center px-8 py-4 bg-primary hover:bg-secondarytext-white font-semibold rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl cursor-pointer"
              >
