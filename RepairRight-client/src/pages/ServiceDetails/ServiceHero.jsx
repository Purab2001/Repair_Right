                ...
                <div className="space-y-6 flex flex-col flex-grow">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="text-center p-4 bg-white/5 rounded-2xl border border-white/10">
                            ...
                            <div className="text-sm text-base-content/70">Quick Service</div>
                        </div>
                        <div className="text-center p-4 bg-white/5 rounded-2xl border border-white/10">
                            <FiAward className="text-primary text-2xl mx-auto mb-2" />
                            <div className="text-sm text-base-content/70">Quality Assured</div>
                        </div>                    </div>                    {isServiceProvider ? (
                            <div className="bg-info/10 border border-info/20 rounded-lg p-4">
                                ...
                                <p className="text-sm text-base-content/70">
                                    ...
                                    <a href="/manage-service" className="text-primary hover:underline ml-1">
                                        Manage Services
                                    </a> page.
                                </p>
                            </div>
                            ...
                            <div className="bg-success/10 border border-success/20 rounded-lg p-4">
                                ...
                                <p className="text-sm text-base-content/70">
                                    ...
                                    {existingBooking?.date && ` for ${new Date(existingBooking.date).toLocaleDateString()}`}.
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onClick={onBookNow}
                                className="inline-flex items-center justify-center px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl cursor-pointer"
                            >
